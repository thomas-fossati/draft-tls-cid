...
# Trasport Agnostic Security Associatiation Extension
...
In the case of hotp(1) option the initial 'cid' is is calculated using the HOTP algorithm ({{RFC4226}}) as follows:
