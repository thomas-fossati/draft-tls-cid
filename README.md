# Transport Agnostic Security Association Extension for TLS

This is the working area for the Individual internet-draft, "Transport Agnostic Security Association Extension for TLS".

* [Editor's copy](https://thomas-fossati.github.io/draft-tls-cid/)
* [Individual Draft] (https://tools.ietf.org/html/draft-mavrogiannopoulos-tls-cid)
